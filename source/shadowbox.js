 ...
 * Lightbox-like effect. See http://shadowbox-js.com/ for more information.
 *
 * Known issues:
 *
 ...
 * @license     http://shadowbox-js.com/LICENSE
 */
(function(){
    ...
    S = {
        ...
        /**
         * A map of adapter names to their global namespaces.
         *
         * @var     Object
         * @public
         */
        ...
        init: function(opts){
            ...
            if(S.options.useSizzle && !window['Sizzle'])
                // jQuery 1.3.2 doesn't expose Sizzle to the global namespace...
                if(window['jQuery'])
